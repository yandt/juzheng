...
export const zh = {
  ...
  'comp.matchProcessName': '进程名 (process_name)',
  'comp.matchProcessPath': '进程路径 (process_path)',
  'comp.matchProcessPathRegex': '进程路径正则 (process_path_regex)',
...
export const en: typeof zh = {
  ...
  'comp.matchProcessName': 'Process name (process_name)',
  'comp.matchProcessPath': 'Process path (process_path)',
  'comp.matchProcessPathRegex': 'Process path regex (process_path_regex)',
